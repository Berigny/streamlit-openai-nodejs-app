...
# Retrieve the MongoDB credentials from Streamlit's secrets
...
database_name = "streamlit-openai-nodejs-app"  # Replace with your actual database name
collection_name = "streamlit"  # Replace with your actual collection name
